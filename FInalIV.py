...
def main(page: ft.Page):
    ...
    def on_resize(e):
        settings_sheet.content.width = calc_settings_width()
        page.update()
    ...
    # ---------- Buscador: actualizar solo la fila de libros ----------
